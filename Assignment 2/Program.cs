...
namespace Assignment_2
{
  class Program
  {
    static void Main(string[] args)
    {
            ...
            //Stock stockTen = new Stock("GOOG", "Google", 4.6m, 115.3m);
            //Stock stockEle = new Stock("AAPL", "Apple", 5m, 147.6m);
            ...
            //client2.StockList.AddStock(stockTen);
            //client2.StockList.AddStock(stockEle);
